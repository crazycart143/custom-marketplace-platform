    ...
    <div className="min-h-screen bg-slate-50 pt-32 pb-20 px-6">
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl lg:text-5xl font-extrabold text-black tracking-tight mb-4 text-center">
        ...
        <div className="mt-12 text-center text-slate-500 text-sm">
          ...
          <p className="mt-2 text-center">Need help? <a href="/support" className="text-brand font-bold hover:underline">Contact our seller support team.</a></p>
        </div>
      </div>
    </div>
  );
